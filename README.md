...
## Usage
  1. ~~Run [vrfinal](https://github.com/KhiewJianBin/VR-Puzzle-Room/blob/main/VRFinal/vrfinal.exe)~~ Due to an issue, run vrfinal.exe with command line argument -nolog in VRFinal folder
